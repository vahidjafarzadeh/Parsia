...
var Autocomplete = function() {
    ...
    var initStaticAutocomplete = function() {
        ...
        const staticFilter = new Filter(1, 100, staticWhere.getList(), (config.orderBy ? config.orderBy.get() : null));
        var staticItem = {};
        ...
        config.element.select2({
            ...
            function(e) {
                ...
                if (config.multipleSelect) {
                    const wrapper = $(e.target).closest(".form-group").next(".multiple-select-wrapper");
        ...
        config.element.select2({
            ...
            ajax: {
                ...
                data: function(term, page) {
                    ...
                    dynamicFilter = new Filter(1,
                        20,
                        dynamicWhere.getList(),
