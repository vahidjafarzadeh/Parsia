!function(a, b, c, d) {
    ...
    function h(b, c, d) {
        ...
        return function() {
            const c = new Error("get-stack-trace");
            const d = c && c.stack
                ? c.stack.replace(/^[^\(]+?[\n$]/gm, "").replace(/^\s+at\s+/gm, "")
                .replace(/^Object.<anonymous>\s*\(/gm, "{anonymous}()@")
                : "Unknown Stack Trace";
            const f = a.console && (a.console.warn || a.console.log);
    ...
    function x(a, b) {
        ...
        this.manager = a, this.callback = b, this.element = a.element, this.target =
            ...
            function(b) { k(a.options.enable, [a]) && c.handler(b) }, this.init()
    }

    function y(a) {
        var b;
        const c = a.options.inputClass;
        return new(b = c ? c : xa ? M : ya ? P : wa ? R : L)(a, z)
    }

    function z(a, b, c) {
        const d = c.pointers.length;
        const e = c.changedPointers.length;
        const f = b & Ea && d - e === 0;
        const g = b & (Ga | Ha) && d - e === 0;
        c.isFirst = !!f, c.isFinal = !!g, f && (a.session = {}), c.eventType =
            b, A(a, c), a.emit("hammer.input", c), a.recognize(c), a.session.prevInput = c
    }
    ...
    function A(a, b) {
        ...
        const d = b.pointers;
        const e = d.length;
        c.firstInput || (c.firstInput = D(b)), e > 1 && !c.firstMultiple
            ? c.firstMultiple = D(b)
            : 1 === e && (c.firstMultiple = !1);
        const f = c.firstInput;
        const g = c.firstMultiple;
        const h = g ? g.center : f.center;
        const i = b.center = E(d);
        b.timeStamp = ra(), b.deltaTime = b.timeStamp - f.timeStamp, b.angle = I(h, i), b.distance =
            H(h, i), B(c, b), b.offsetDirection = G(b.deltaX, b.deltaY);
        const j = F(b.deltaTime, b.deltaX, b.deltaY);
        b.overallVelocityX = j.x, b.overallVelocityY = j.y, b.overallVelocity = qa(j.x) > qa(j.y) ? j.x : j.y, b.scale =
            g ? K(g.pointers, d) : 1, b.rotation = g ? J(g.pointers, d) : 0, b.maxPointers = c.prevInput
            ? b.pointers.length > c.prevInput.maxPointers
            ? b.pointers.length
            : c.prevInput.maxPointers
            : b.pointers.length, C(c, b);
        var k = a.element;
    ...
    function B(a, b) {
        const c = b.center;
        var d = a.offsetDelta || {}, e = a.prevDelta || {};
        const f = a.prevInput || {};
    ...
    function C(a, b) {
        var c, e, f, g;
        const h = a.lastInterval || b;
        const i = b.timeStamp - h.timeStamp;
        if (b.eventType != Ha && (i > Da || h.velocity === d)) {
            const j = b.deltaX - h.deltaX;
            const k = b.deltaY - h.deltaY;
            const l = F(i, j, k);
    ...
    function Q(a, b) {
        const c = s(a.touches);
        const d = this.targetIds;
        if (b & (Ea | Fa) && 1 === c.length) return d[c[0].identifier] = !0, [c, c];
        var e, f;
        const g = s(a.changedTouches);
        const h = [];
        var i = this.target;
    ...
    function R() {
        ...
        const a = j(this.handler, this);
        this.touch = new P(this.manager, a), this.mouse = new L(this.manager, a), this.primaryTouch =
    ...
    function U(a) {
        for (var b = a.srcEvent.clientX, c = a.srcEvent.clientY, d = 0; d < this.lastTouches.length; d++) {
            const e = this.lastTouches[d];
            const f = Math.abs(b - e.x);
            const g = Math.abs(c - e.y);
    ...
    function Y(a) {
        this.options = la({}, this.defaults, a || {}), this.id = v(), this.manager = null, this.options.enable =
            l(this.options.enable, !0), this.state = nb, this.simultaneous = {}, this.requireFail = []
    }
    ...
    function ga() {
        Y.apply(this, arguments), this.pTime = !1, this.pCenter = !1, this._timer = null, this._input =
            null, this.count = 0
    }
    ...
    function ia(a, b) {
        this.options = la({}, ha.defaults, b || {}), this.options.inputTarget =
            this.options.inputTarget || a, this.handlers = {}, this.session = {}, this.recognizers =
            [], this.oldCssProps = {}, this.element = a, this.input = y(this), this.touchAction =
            new V(this, this.options.touchAction), ja(this, !0), g(this.options.recognizers,
            function(a) {
                const b = this.add(new a[0](a[1]));
    ...
    la = "function" != typeof Object.assign
        ? function(a) {
            ...
            for (var b = Object(a), c = 1; c < arguments.length; c++) {
                const e = arguments[c];
                if (e !== d && null !== e) for (let f in e) e.hasOwnProperty(f) && (b[f] = e[f])
            }
            return b
        }
        : Object.assign;
    ...
    x.prototype = {
        handler: function() {},
        init: function() {
            this.evEl && m(this.element, this.evEl, this.domHandler), this.evTarget &&
                m(this.target, this.evTarget, this.domHandler), this.evWin &&
                m(w(this.element), this.evWin, this.domHandler)
        },
        destroy: function() {
            this.evEl && n(this.element, this.evEl, this.domHandler), this.evTarget &&
                n(this.target, this.evTarget, this.domHandler), this.evWin &&
                n(w(this.element), this.evWin, this.domHandler)
        }
    };
    ...
    i(L,
        x,
        {
            handler: function(a) {
                var b = Sa[a.type];
                b & Ea && 0 === a.button && (this.pressed = !0), b & Fa && 1 !== a.which && (b = Ga), this.pressed &&
                (b & Ga && (this.pressed = !1), this.callback(this.manager,
                    b,
                    { pointers: [a], changedPointers: [a], pointerType: Ba, srcEvent: a }))
            }
        });
    ...
    a.MSPointerEvent && !a.PointerEvent && (Xa = "MSPointerDown", Ya = "MSPointerMove MSPointerUp MSPointerCancel"), i(
        ...
        x,
        {
            handler: function(a) {
                const b = this.store;
                var c = !1;
                const d = a.type.toLowerCase().replace("ms", "");
                const e = Va[d];
                const f = Wa[a.pointerType] || a.pointerType;
                const g = f == za;
        ...
        x,
        {
            handler: function(a) {
                ...
                if (b === Ea && (this.started = !0), this.started) {
                    const c = O.call(this, a, b);
                    b & (Ga | Ha) && c[0].length - c[1].length === 0 && (this.started = !1), this.callback(this.manager,
                        b,
                        { pointers: c[0], changedPointers: c[1], pointerType: za, srcEvent: a })
                }
            }
        });
    ...
    i(R,
        x,
        {
            handler: function(a, b, c) {
                const d = c.pointerType == za;
                const e = c.pointerType == Ba;
    ...
    V.prototype = {
        set: function(a) {
            a == gb && (a = this.compute()), fb &&
                this.manager.element.style &&
                mb[a] &&
                (this.manager.element.style[eb] = a), this.actions = a.toLowerCase().trim()
        },
        update: function() { this.set(this.manager.options.touchAction) },
        compute: function() {
            var a = [];
            return g(this.manager.recognizers,
                function(b) { k(b.options.enable, [b]) && (a = a.concat(b.getTouchAction())) }), W(a.join(" "))
        },
        preventDefaults: function(a) {
            const b = a.srcEvent;
            const c = a.offsetDirection;
            if (this.manager.session.prevented) return void b.preventDefault();
            const d = this.actions;
            const e = p(d, jb) && !mb[jb];
            const f = p(d, lb) && !mb[lb];
            const g = p(d, kb) && !mb[kb];
            if (e) {
                const h = 1 === a.pointers.length;
                const i = a.distance < 2;
                const j = a.deltaTime < 250;
                if (h && i && j) return
            }
    ...
    Y.prototype = {
        ...
        requireFailure: function(a) {
            ...
            const b = this.requireFail;
            return a = _(a, this), -1 === r(b, a) && (b.push(a), a.requireFailure(this)), this
        },
        dropRequireFailure: function(a) {
            if (f(a, "dropRequireFailure", this)) return this;
            a = _(a, this);
            const b = r(this.requireFail, a);
        ...
        recognize: function(a) {
            ...
            return k(this.options.enable, [this, b])
                ? (this.state & (rb | sb | tb) && (this.state = nb), this.state =
                    this.process(b), void(this.state & (ob | pb | qb | sb) && this.tryEmit(b)))
        ...
        aa,
        {
            ...
            getTouchAction: function() {
                const a = this.options.direction;
                const b = [];
                return a & Na && b.push(lb), a & Oa && b.push(kb), b
            },
            directionTest: function(a) {
                const b = this.options;
                var c = !0, d = a.distance, e = a.direction;
                const f = a.deltaX;
                const g = a.deltaY;
                return e & b.direction ||
                (b.direction & Na
                    ? (e = 0 === f ? Ia : 0 > f ? Ja : Ka, c = f != this.pX, d = Math.abs(a.deltaX))
                    : (e = 0 === g ? Ia : 0 > g ? La : Ma, c = g != this.pY, d = Math.abs(a.deltaY))), a.direction =
                    e, c && d > b.threshold && e & b.direction
            },
            attrTest: function(a) {
                return aa.prototype.attrTest.call(this, a) &&
        ...
        Y,
        {
            ...
            process: function(a) {
                const b = this.options;
                const c = a.pointers.length === b.pointers;
                const d = a.distance < b.threshold;
                const f = a.deltaTime > b.time;
        ...
        aa,
        {
            ...
            attrTest: function(a) {
                var b;
                const c = this.options.direction;
                return c & (Na | Oa)
                    ? b = a.overallVelocity
                    : c & Na
                    ? b = a.overallVelocityX
                    : c & Oa && (b = a.overallVelocityY), this._super.attrTest.call(this, a) &&
                    c & a.offsetDirection &&
        ...
        Y,
        {
            ...
            process: function(a) {
                ...
                if (d && f && c) {
                    ...
                    const g = this.pTime ? a.timeStamp - this.pTime < b.interval : !0;
                    const h = !this.pCenter || H(this.pCenter, a.center) < b.posThreshold;
                    this.pTime = a.timeStamp, this.pCenter =
                        a.center, h && g ? this.count += 1 : this.count = 1, this._input = a;
                    const i = this.count % b.taps;
                    if (0 === i)
                        return this.hasRequireFailures()
                            ? (this._timer = e(function() { this.state = rb, this.tryEmit() }, b.interval, this), ob)
                            : rb
                }
                return tb
            },
        ...
        inputClass: null,
        preset: [
            [ea, { enable: !1 }], [ca, { enable: !1 }, ["rotate"]], [fa, { direction: Na }],
            [ba, { direction: Na }, ["swipe"]], [ga], [ga, { event: "doubletap", taps: 2 }, ["tap"]], [da]
        ],
        cssProps: {
            userSelect: "none",
            touchSelect: "none",
    ...
    ia.prototype = {
        set: function(a) {
            return la(this.options, a), a.touchAction && this.touchAction.update(), a.inputTarget &&
                (this.input.destroy(), this.input.target = a.inputTarget, this.input.init()), this
        },
        stop: function(a) { this.session.stopped = a ? vb : ub },
        recognize: function(a) {
            const b = this.session;
            if (!b.stopped) {
                this.touchAction.preventDefaults(a);
                let c;
                const d = this.recognizers;
                let e = b.curRecognizer;
                (!e || e && e.state & rb) && (e = b.curRecognizer = null);
                for (let f = 0; f < d.length;)
                    c = d[f], b.stopped === vb || e && c != e && !c.canRecognizeWith(e) ? c.reset() : c.recognize(a),
        ...
        add: function(a) {
            ...
            const b = this.get(a.options.event);
            return b && this.remove(b), this.recognizers.push(a), a.manager = this, this.touchAction.update(), a
        },
        remove: function(a) {
            if (f(a, "remove", this)) return this;
            if (a = this.get(a)) {
                const b = this.recognizers;
                const c = r(b, a);
        ...
        emit: function(a, b) {
            ...
            const c = this.handlers[a] && this.handlers[a].slice();
            if (c && c.length) {
                b.type = a, b.preventDefault = function() { b.srcEvent.preventDefault() };
                for (let d = 0; d < c.length;) c[d](b), d++
            }
        },
        destroy: function() {
            this.element && ja(this, !1), this.handlers = {}, this.session = {}, this.input.destroy(), this.element =
                null
        }
    }, la(ha,
        {
